...
```{r}
trainingset <- read.csv("C:/Users/NaveenSrikanthD/Downloads/pml-training.csv", na.strings=c("NA","#DIV/0!", ""),header=TRUE)
```
```{r}
# Loading the testing data set 
testingset <- read.csv("C:/Users/NaveenSrikanthD/Downloads/pml-testing.csv",na.strings=c("NA","#DIV/0!", ""),header=TRUE)
```
...
pml_write_files = function(x){
  n = length(x)
  for(i in 1:n){
    filename = paste0("C:/Users/NaveenSrikanthD/Documents/problem_id_",i,".txt")
